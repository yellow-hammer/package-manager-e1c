...
Процедура пм_КонтрольДлительныхОпераций() Экспорт
	
	АктивныеДлительныеОперации = пм_ДлительныеОперацииКлиент.АктивныеДлительныеОперации();
...
Процедура ПроконтролироватьДлительныеОперации(АктивныеДлительныеОперации)
	...
	Статусы = пм_ДлительныеОперацииВызовСервера.ОперацииВыполнены(ЗаданияДляПроверки, ЗаданияДляОтмены);
	...
	ПодключитьОбработчикОжидания("пм_КонтрольДлительныхОпераций", Интервал, Истина);
...
Функция ПроконтролироватьДлительнуюОперацию(ДлительнаяОперация, Статус)
	...
	Если Статус.Статус = "Выполнено" Тогда
		...
		пм_ДлительныеОперацииКлиент.ПоказатьОповещение(ДлительнаяОперация.ОповещениеПользователя);
