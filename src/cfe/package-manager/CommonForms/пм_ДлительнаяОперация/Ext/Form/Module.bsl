...
Процедура ПриОткрытии(Отказ)
	...
	Если Параметры.ВыводитьОкноОжидания Тогда
		...
		пм_ДлительныеОперацииКлиент.ОжидатьЗавершение(ДлительнаяОперация, ОповещениеОЗавершении, ПараметрыОжидания);
	КонецЕсли;
...
Процедура ПоказатьОповещение()
	...
	пм_ДлительныеОперацииКлиент.ПоказатьОповещение(Параметры.ОповещениеПользователя, ВладелецФормы);
...
Функция ПроверитьИОтменитьЕслиВыполняется(ИдентификаторЗадания)
	...
	ДлительнаяОперация = пм_ДлительныеОперации.ОперацияВыполнена(ИдентификаторЗадания);
...
Процедура ОтменитьВыполнениеЗадания(ИдентификаторЗадания)
	...
	пм_ДлительныеОперации.ОтменитьВыполнениеЗадания(ИдентификаторЗадания);
